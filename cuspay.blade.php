...
<body class="flex bg-gray-100">
    ...
    <div class="flex">
        <aside class="w-64 min-h-screen bg-green-900 text-white p-4">
            ...
            <nav class="flex flex-col space-y-4">
                <a href="/dashboardwapi" class="py-2.5 px-6 bg-green-900 hover:bg-green-800 flex items-center">
                ...
                <a href="/cususer" class="py-2.5 px-6 bg-green-900 hover:bg-green-800 flex items-center">
                ...
                <a href="/cuspay" class="py-2.5 px-6 bg-green-900 hover:bg-green-800 flex items-center">
                    <svg class="w-6 h-6 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="/cusorder" class="py-2.5 px-6 bg-green-900 hover:bg-green-800 flex items-center">
                    <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="flex flex-col flex-1 p-6">
        <!-- Header -->
        <header
            class="flex flex-col md:flex-row  items-center justify-between bg-white p-6 rounded shadow space-y-4 md:space-y-0">
            ...
            <div class="w-full md:w-1/2 bg-white pt-11 p-7 rounded-lg shadow-lg">
                ...
                <div class="max-w-md mx-auto bg-white p-6 rounded-lg mt-6">
                    <form action="#" method="post" class="space-y-4">
                        ...
                        <!-- Harga Bayar Field -->
                        <div>
                            <label for="harga_bayar" class="block text-sm font-medium text-gray-700">Harga Bayar
                                :</label>
                            <input type="number" id="harga_bayar" name="harga_bayar"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-green-500 focus:ring-green-500"
                        ...
                        <div>
                            <button type="submit"
                                class="w-full bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Bayar</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-green-900 text-white">
                            <th class="border-b-2 p-4">Header 1</th>
                            <th class="border-b-2 p-4">Header 2</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="border-b p-3 text-center">Data 1</td>
                            <td class="border-b p-3 text-center">Data 2</td>
                        </tr>
                        <tr>
                            <td class="border-b p-3 text-center">Data 3</td>
                            <td class="border-b p-3 text-center">Data 4</td>
                        </tr>
                        <tr>
                            <td class="border-b p-3 text-center">Data 5</td>
                            <td class="border-b p-3 text-center">Data 6</td>
                        </tr>
                    </tbody>
                </table>
            </div>
